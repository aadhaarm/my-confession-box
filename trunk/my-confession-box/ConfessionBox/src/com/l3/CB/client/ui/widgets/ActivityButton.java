...
public class ActivityButton extends AbsolutePanel {
	...
	public ActivityButton(final Activity activity, final Confession confession,
			...
			String btnStyleName, final Image buttonImage) {
		super();
	 ...
	 * @return
	 */
	private Timer getActivityTimer(final Activity activity,
			final Confession confession, final UserInfo userInfo,
			final ConfessionServiceAsync confessionService, final Label btnCount) {
